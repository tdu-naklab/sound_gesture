                            ...
                            if data[k,l]==True:
                                ...
                                if speaker2.get_busy()!=True:
                                    ...
                                    if center_x1 > 500 and center_x1 < 530:
                                        ...
                                        center_x1 = 0
                                        center_y1 = 600
                                    if center_x1 >= 400 and center_x1 < 500 or center_x1 > 530 and center_x1 <= 630 :
                                        tokuten += 50
                                        good += 1            
                                        center_x1 = 0
                                        center_y1 = 600
                            ...
                            if data[k,l]==True:
                                ...
                                if speaker3.get_busy()!=True:
                                    ...
                                    if center_x2 > 100 and center_x2 < 130:
                                        ...
                                        center_x2 = 600
                                        center_y2 = 550
                                    if center_x2 >= 0 and center_x2 <= 100 or center_x2 >= 130 and center_x2 < 230 :
                                        tokuten += 50
                                        good += 1            
                                        center_x2 = 600
                                        center_y2 = 550
                            ...
                            if data[k,l]==True:
                                ...
                                if speaker4.get_busy()!=True:
                                    ...
                                    if center_x3 > 500 and center_x3 < 530:
                                        ...
                                        center_x3 = 1000
                                        center_y3 = 0
                                    if center_x3 >= 400 and center_x3 <= 500 or center_x3 >= 530 and center_x3 < 630 :
                                        tokuten += 50
                                        good += 1            
                                        center_x3 = 1000
                                        center_y3 = 0
